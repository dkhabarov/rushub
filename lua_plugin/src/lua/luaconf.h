...
#define LUA_PDIR	"!\\plugins\\"
#define LUA_LCDIR	"!\\scripts\\libs\\"
#define LUA_PATH_DEFAULT  \
	LUA_CDIR "?.lua;" LUA_CDIR "?\\init.lua;" \
        "!\\?.lua;"       "!\\?\\init.lua;" \
  LUA_LDIR "?.lua;" LUA_LDIR "?\\init.lua;" \
  LUA_LCDIR"?.lua;" LUA_LCDIR"?\\init.lua;" \
  LUA_PDIR "?.lua;" LUA_PDIR "?\\init.lua;"
...
#define LUA_PATH_DEFAULT  \
  ...
  LUA_CDIR"?.lua;" LUA_CDIR"?/init.lua"
#define LUA_CPATH_DEFAULT \
  "./?.so;./libs/?.so;" LUA_CDIR"?.so;"  LUA_CDIR"loadall.so"
#endif
