...
typedef enum { /** Param's hash */
	ePH_IP         = 181418,     //< "sIP"
	ePH_UID        = 184711,     //< "UID"
	ePH_TAG        = 8643147,    //< "sTag"
	ePH_IPCONN     = 147290825,  //< "sIPConn"
	ePH_KICK       = 273220706,  //< "bKick"
	ePH_NICK       = 273271029,  //< "sNick"
	ePH_CONN       = 274209453,  //< "sConn"
	ePH_OPEN       = 274638894,  //< "iOpen"
	ePH_HIDE       = 283519753,  //< "bHide"
	ePH_MODE       = 283524765,  //< "sMode"
	ePH_BYTE       = 284088469,  //< "iByte"
	ePH_DATA       = 287569088,  //< "sData"
	ePH_PORT       = 297594872,  //< "iPort"
	ePH_DESC       = 298666151,  //< "sDesc"
	ePH_FRACTION   = 455004380,  //< "sFraction"
	ePH_REGHUBS    = 753727999,  //< "iRegHubs"
	ePH_INUSERLIST = 706509577,  //< "bInUserList"
	ePH_REDIRECT   = 711850660,  //< "bRedirect"
	ePH_ENTERTIME  = 763897831,  //< "iEnterTime"
	ePH_SUPPORTS   = 808041195,  //< "sSupports"
	ePH_PORTCONN   = 983570313,  //< "iPortConn"
	ePH_INOPLIST   = 1099547535, //< "bInOpList"
	ePH_INIPLIST   = 1099731730, //< "bInIpList"
	ePH_BANDWIDTH  = 1137898845, //< "iBandwidth"
	ePH_SHARE      = 1265448161, //< "iShare"
	ePH_CLIENTV    = 1770158059, //< "sClientVersion"
	ePH_PROFILE    = 1940585483, //< "iProfile"
	ePH_SLOTS      = 2071487254, //< "iSlots"
	ePH_VERSION    = 2110960858, //< "sVersion"
	ePH_EMAIL      = 2212980532, //< "sEmail"	
	ePH_DOWNLOAD   = 2361868501, //< "iDownload"
	ePH_LIMIT      = 2462582922, //< "iLimit"
	ePH_MACADDRESS = 3286209708, //< "sMacAddress"
	ePH_MYINFO     = 3304895608, //< "sMyINFO"
	ePH_CLIENTN    = 3439278230, //< "sClientName"
	ePH_USHUBS     = 3736623303, //< "iUsHubs"
	ePH_OPHUBS     = 3736624964, //< "iOpHubs"
} tParamHash;
