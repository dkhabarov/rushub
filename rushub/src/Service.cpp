...
/** InstallService */
int Service::InstallService(char * sName, const char * sConfPath) {
...
/** UninstallService */
int Service::UninstallService(char * sName) {
...
int Service::ServiceStart(char * sName) {
...
int Service::ServiceStop(char * sName) {
